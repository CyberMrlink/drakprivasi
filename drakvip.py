...
╲╲┃┈┏┓┈┃
▔▔╰━╯╰━╯\033[1;91m
             \033[1;92mMrlinkerrorsystem\033[1;91m
              \033[1;97m
                 [+]Author : Mrlinkerrorsystem[+]\033[1;91m
       =============================================           
        ~[+]Github : Https://github.com/Netizen62:v[+]\033[1;97m~  \033[1;97m
       =============================================
...
def pilih():
    zedd = raw_input('╚═\x1b[1;91m▶@rootMrlink\x1b[1;97m ')
    if zedd == '':
...
def hack_pilih():
    hack = raw_input('╚═\x1b[1;91m▶@rootMrlink\x1b[1;97m ')
    if hack == '':
        print '\x1b[1;91m[!] Can\'t empty'
        hack_pilih()
    else:
...
def yahoo_pilih():
    go = raw_input('╚═\x1b[1;91m▶@rootMrlink\x1b[1;97m ')
    if go == '':
        print '\x1b[1;91m[!] Can\'t empty'
        yahoo_pilih()
    else:
...
def grab_pilih():
    cuih = raw_input('╚═\x1b[1;91m▶@rootmrlink\x1b[1;97m ')
    if cuih == '':
        print '\x1b[1;91m[!] Can\'t empty'
        grab_pilih()
    else:
...
def bot_pilih():
    bots = raw_input('╚═\x1b[1;91m▶@rootmrlink\x1b[1;97m ')
    if bots == '':
        print '\x1b[1;91m[!] Can\'t empty'
        bot_pilih()
    else:
...
def react_pilih():
    global tipe
    aksi = raw_input('╚═\x1b[1;91m▶@rootmrlink\x1b[1;97m ')
    if aksi == '':
        print '\x1b[1;91m[!] Can\'t empty'
        react_pilih()
    else:
...
def pilih_lain():
    other = raw_input('╚═\x1b[1;91m▶@rootmrlink\x1b[1;97m ')
    if other == '':
        print '\x1b[1;91m[!] Can\'t empty'
        pilih_lain()
    else:
...
def guard():
    ...
    print '║-> \x1b[1;31;40m0. Back'
    print '\x1b[1;37;40m║'
    g = raw_input('╚═\x1b[1;91m▶@rootmrlink\x1b[1;97m ')
    if g == '1':
        aktif = 'true'
        gaz(toket, aktif)
    else:
